...
class PPAFHUM:
    ...
    '''
    Third variation of priority patrolling algorithm
    '''
    ...
    def utility(self, path):
        '''
        Utility function (modified - double counting)
        '''
        reward = 0
        n = [0]
    ...
    def callback_ready(self, req):
        ...
        Verify algorithm
        '''
        if req.algo == 'ppa_fhum_3' and self.ready:
...
if __name__ == '__main__':
    rospy.init_node('ppa_fhum_3', anonymous = True)
